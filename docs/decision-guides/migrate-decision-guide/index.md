...
- **[Migração de escopo expandido: Os requisitos de dados excedem a capacidade da rede durante um esforço de migração](../../migrate/azure-best-practices/network-capacity-exceeded.md):** Discute os mecanismos de migração de dados alternativos para cenários em que a migração de dados é prejudicada pela largura de banda de rede disponível.
