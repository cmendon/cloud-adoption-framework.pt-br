...
**Planos de mudança empresarial:** para qualquer cenário de migração complexo, é necessário criar um plano de alteração empresarial para garantir a comunicação clara em relação às alterações nos processos empresariais, nas experiências dos usuários e no tempo dos esforços necessários para a integração das alterações. No caso de esforços de migração global, o plano deve incluir considerações para usuários finais em cada geografia afetada.
