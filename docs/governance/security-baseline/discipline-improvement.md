...
- Avalie as políticas de [acesso de privilégios mínimos](/azure/active-directory/users-groups-roles/roles-delegate-by-task) de sua organização e use funções baseadas em tarefas para fornecer acesso a recursos específicos.
...
> [à segurança do Azure](/azure/security/azure-security)[saiba mais sobre registro em log, relatórios e monitoramento](../../decision-guides/log-and-report/index.md)
