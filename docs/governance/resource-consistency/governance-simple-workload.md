...
![O administrador global do Azure ad cria a conta](../../_images/governance-1-2.png)
...
![O proprietário da conta do Azure cria](../../_images/governance-1-3.png)
...
![O proprietário da conta do Azure associa o locatário do Azure ad](../../_images/governance-1-4.png)
...
![O proprietário da conta do Azure adiciona o * * proprietário da carga de trabalho](../../_images/governance-1-5.png)
...
![O * * proprietário da carga de trabalho * * foi atribuído à função](../../_images/governance-1-6.png)
...
![O * * proprietário da carga de trabalho * * cria](../../_images/governance-1-7.png)
...
![O * * proprietário da carga de trabalho * *](../../_images/governance-1-8.png)
