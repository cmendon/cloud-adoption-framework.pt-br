...
description: Use o Cloud Adoption Framework para o Azure para aprender a avaliar as políticas existentes, criar uma base de governança inicial e adicionar ferramentas de governança iterativamente.
