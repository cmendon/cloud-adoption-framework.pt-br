...
**Risco técnico:** As configurações de controle de acesso insuficientes ou ad hoc podem introduzir o risco de acesso não autorizado a recursos confidenciais ou de missão crítica.
