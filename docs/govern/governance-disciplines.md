...
description: Use a estrutura de adoção de nuvem do Azure para saber mais sobre gerenciamento de custos, aceleração de implantação, linha de base de identidade, consistência de recursos e linha de base de segurança.
