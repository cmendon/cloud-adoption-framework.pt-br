---
title: Configurar o serviço para uma assinatura
description: Saiba como configurar os serviços de gerenciamento de servidor do Azure para uma assinatura implantando agentes de serviço em seus servidores e habilitando soluções de gerenciamento.
