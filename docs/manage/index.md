...
description: Use o Cloud Adoption Framework para o Azure para saber como desenvolver as abordagens empresariais e técnicas necessárias para um gerenciamento de nuvem eficaz.
