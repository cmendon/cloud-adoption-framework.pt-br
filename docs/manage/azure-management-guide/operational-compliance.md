...
description: Saiba como garantir a estabilidade da empresa por meio da conformidade operacional, reduzindo a probabilidade de interrupções ou vulnerabilidades.
...
## <a name="update-management"></a>[Gerenciamento de atualizações](#tab/UpdateManagement)
