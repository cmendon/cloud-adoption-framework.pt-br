...
Cargas de trabalho previsíveis são aquelas que sempre precisam estar disponíveis com as VMs em execução. Por exemplo, linha de negócios aplicativos, como um sistema SAP ERP. Por outro lado, cargas de trabalho imprevisíveis são variáveis, como VMs ativadas durante a alta demanda e desativadas quando a demanda é baixa.
...
- **Política:** O Azure Policy se aplica e impõe regras e efeitos sobre seus recursos, para que os estes estejam em conformidade com os requisitos corporativos e os SLAs.
...
**nome da marca** | **Valor**
--- | ---
Centro de Custo | 12345: Deve ser um centro de custo válido da SAP.
...
![Monitorando](./media/contoso-migration-infrastructure/monitoring.png)
...
Negar | DenyAllInBound | Any | Any | Any
