---
title: Protegendo e gerenciando cargas de trabalho migradas para o Azure
description: Use a estrutura de adoção de nuvem para o Azure para aprender as práticas recomendadas para operar, gerenciar e proteger suas cargas de trabalho migradas.
