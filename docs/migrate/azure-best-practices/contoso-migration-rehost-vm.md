---
title: Rehospedar um aplicativo local em VMs do Azure com Azure Site Recovery
description: Use a estrutura de adoção de nuvem para o Azure para aprender a hospedar novamente um aplicativo local com uma migração de computadores locais para o Azure.
