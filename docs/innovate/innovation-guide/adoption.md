---
title: 'Inovação do Azure: Preparar para comentários'
description: Saiba como usar as ferramentas do Azure para coletar comentários quantitativos e qualitativos sobre aplicativos Web e APIs hospedados no GitHub.
...
## <a name="quantitative-feedback-for-web-apps"></a>[Comentários quantitativos para aplicativos Web](#tab/Quantitative-Apps)
...
## <a name="quantitative-feedback-for-apis"></a>[Comentários quantitativos para APIs](#tab/Quantitative-APIs)
...
## <a name="qualitative-feedback"></a>[Comentários qualitativos](#tab/Qualitative)
...
O Azure Boards e o Azure Pipelines exigem um portal separado do GitHub e do Azure. Introdução ao uso do [Azure DevOps](https://dev.azure.com).
...
- [Introdução ao Azure Boards](https://docs.microsoft.com/azure/devops/boards/get-started/?view=azure-devops)
- [Azure Boards e GitHub](https://docs.microsoft.com/azure/devops/boards/github?view=azure-devops)

## <a name="close-the-loop-with-pipelines"></a>[Fechar o loop com pipelines](#tab/pipelines)
