...
description: Use a estrutura de adoção de nuvem para o Azure para aprender os processos de adoção de nuvem e a operação de cargas de trabalho hospedadas na nuvem.
