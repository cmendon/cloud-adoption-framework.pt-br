...
| Desejo otimizar a entrega em farms de servidores de aplicativos, aumentando a segurança com um firewall do aplicativo Web. | [Application Gateway do Azure](https://docs.microsoft.com/azure/application-gateway) <br/>[Azure Front Door Service](https://docs.microsoft.com/azure/frontdoor) |
...
| Preciso de funcionalidades de firewall nativo com alta disponibilidade interna, escalabilidade irrestrita na nuvem e nenhuma manutenção. | [Firewall do Azure](https://docs.microsoft.com/azure/firewall) |
