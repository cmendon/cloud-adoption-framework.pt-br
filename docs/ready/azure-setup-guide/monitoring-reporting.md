...
description: Use o Cloud Adoption Framework para o Azure para saber como configurar o monitoramento, os relatórios e os alertas para o seu ambiente de gerenciamento do Azure.
author: timleyden
ms.author: tileyden
ms.date: 04/09/2019
ms.topic: guide
